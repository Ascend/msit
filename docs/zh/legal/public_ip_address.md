...
| 开源软件 | - | msit/components/debug/compare/setup.py | <https://gitcode.com/Ascend/msit/tree/26.1.0/msit/components/debug/compare> | 用于compare组件打包成python包的主页说明 |
...
| 开源软件 | - | msit/components/config/config.ini | <https://gitcode.com/Ascend/msit/tree/26.1.0/msit/components/debug/compare> | msit debug compare工具仓库地址 |
| 开源软件 | - | msit/components/config/config.ini | <https://gitcode.com/Ascend/msit/tree/26.1.0/msit/components/debug/opcheck> | msit debug opcheck工具仓库地址 |
