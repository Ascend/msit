...
def process_files(directory, out_path):
    ...
    for file in files:
        if file.startswith('batch_info_'):
            ...
            column_names_2 = ['batch_stage', 'batch_size', 'total_need_blocks', 'total_prefill_token', 'max_seq_len', 'req_info', 'preprocess_time', 'forward_time', 'postprocess_time', 'forward_time', 'sample_time', 'postprocess_time', 'total_time', 'batch_id', 'batch_stage', 'batch_size', 'total_need_blocks', 'total_prefill_token', 'max_seq_len', 'req_info', 'preprocess_time', 'forward_time', 'postprocess_time', 'forward_time', 'sample_time', 'postprocess', 'execute_time']
            ...
            batch_df = batch_df[['ibis_batchid', 'batch_stage', 'batch_size', 'total_need_blocks', 'total_prefill_token', 'max_seq_len', 'model_execute_time', 'req_info']]
            # 保存处理后的文件
