...
ALL_OP = ("ActivationOperation", "AsStridedOperation", "CumsumOperation", "GatherOperation", "MatmulOperation",
          "MultinomialOperation", "SplitOperation", "ConcatOperation", "SliceOperation", "SoftmaxOperation",
          "TransposeOperation", "ElewiseOperation", "KVCacheOperation", "ReshapeAndCacheOperation",
          "LinearActivationOperation", "LinearActivationQuantOperation", "LayerNormOperation", "RmsNormOperation",
          "FillOperation", "AllGatherOperation", "AllReduceOperation", "BroadcastOperation", "LinearOperation",
          "LinearQuantOperation", "LinearParallelOperation", "LinearSparseOperation",
          "RopeOperation", "SelfAttentionOperation", "PagedAttentionOperation", "TransdataOperation", "WhereOperation",
          "RepeatOperation", "SetValueOperation", "ReduceOperation", "TopkToppSamplingOperation")

ALL_ASCEND_NAME = (
    "AS31XM1X", "Ascend031", "Ascend035A", "Ascend035B", "Ascend035", "Ascend310B1", "Ascend310B2", "Ascend310B3",
    "Ascend310B4", "Ascend310", "Ascend310P1", "Ascend310P3", "Ascend610", "Ascend610Lite", "Ascend910A", "Ascend910B1",
    "Ascend910B2C", "Ascend910B2", "Ascend910B3", "Ascend910B4-1", "Ascend910B4", "Ascend910B", "Ascend910C1",
    " Ascend910C2", "Ascend910C3", "Ascend910C4-1", " Ascend910C4", "Ascend910PremiumA", "Ascend910ProA",
    "Ascend910ProB",
    "BS9SX1AA", "BS9SX1AB", "BS9SX1AC", "BS9SX2AA", "BS9SX2AB", "Hi3796CV300CS", "Hi3796CV300ES", "MC61AM21AA",
    "MC61AM21AB", "SD3403")

ALL_ARCHITECTURE = (
    "LlamaForCausalLM", "InternLM2ForCausalLM", "Qwen2ForCausalLM", "LlavaNextVideoForConditionalGeneration", "glm4v",
    "internvl_chat", "internvl", "minicpm_llama3_v2", "bunny")
...
ALL_MODEL_TYPE = ("bloom", "codeshell", "deepseekv2", "gpt_neox", "internlm", "llama", "minicpm_llama3_v2", "phi3",
                  "qwen2_moe", "starcoder2", "zhinao", "aquila", "bunny", "cogvlm2", "deepseekvl", "gpt2", "internlm2",
                  "llava", "minicpmv2", "qwen", "qwen2_vl", "telechat", "ziya", "baichuan", "chatglm", "dbrx", "gemma",
                  "gte_qwen", "internlmxcomposer2", "llava_next", "mistral", "qwen2", "skywork", "vlmo", "clip",
                  "deepseek",
                  "glm4v", "idefics2", "internvl", "minicpm", "mixtral", "qwen2_audio", "starcoder", "yivl", "kclgt",
                  "internvl_chat", "llava_next_video",
                  "minicpmv", "MiniCPM-Llama3-V-2_5", "bunny-qwen2")

DTYPE_CATEGORY = ("float16", "float32", "int32", "int64")
SIZE_CATEGORY = ("min", "max", "mean")

SIZE_CATEGORY_HANDLER = {
    "min": lambda x: min(x),
    "max": lambda x: max(x),
...
ALL_OP_PARAM_TYPE = {
    ...
    "AllReduceOperation": {"input": [OpParamType.TENSOR, OpParamType.TENSOR, OpParamType.TENSOR],
    ...
    "ElewiseOperation": {"input": [OpParamType.TENSOR, OpParamType.TENSOR, OpParamType.TENSOR, OpParamType.TENSOR],
                         "output": [OpParamType.TENSOR]},
...
OP_EXECUTE_DELTA_FIELD = (
    "host_setup_time", "host_execute_time", "kernel_execute_time", "aic_cube_fops", "aiv_vector_fops")
for op in ALL_OP:
