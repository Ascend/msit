...
from profiling_analyze.utils import TARGETS

# from profiling_analyze.utils import walk_dict

# "BackendConfig:ScheduleConfig:maxPrefillBatchSize": [40, 50, 60, 80],
# "BackendConfig:ScheduleConfig:supportSelectBatch": [false, true],
# "BackendConfig:ScheduleConfig:maxQueueDelayMicroseconds": [500, 5000],
# "BackendConfig:ScheduleConfig:maxBatchSize": [40, 80, 100],
# "BackendConfig:ScheduleConfig:prefillTimeMsPerReq": [300, 600]
