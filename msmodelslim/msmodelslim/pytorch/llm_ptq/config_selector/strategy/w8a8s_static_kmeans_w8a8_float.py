from msmodelslim.pytorch.llm_ptq.config_selector.strategy.base_layer_selector import W8A8SStaticKMeansSelector, \
    W8A8Selector, FloatSelector
...
class W8A8SStaticKMeansW8A8Float(MixLayerParamRangeSelector):
    """
    W8A8S-Static-KMeans/W8A8/Float三类型层间混精选择。
    """

    def target_mix_type_set(self) -> set:
        return {W8A8SStaticKMeansSelector.mix_type(), W8A8Selector.mix_type(), FloatSelector.mix_type()}
    ...
    def setup(self, *args, **kwargs):
        ...
        self.add_range_selector(min_value=float('-inf'), max_value=threshold1, selector=W8A8SStaticKMeansSelector())
