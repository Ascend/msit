...
| 算法               | 算法介绍       | 适配指导       |
| ------------------ | ------------- | ------------- |
| Iterative Smooth | [Iterative Smooth：离群值抑制算法说明](../算法说明/Iterative_Smooth#iterative-smooth离群值抑制算法说明) | [Iterative Smooth 适配](../算法说明/Iterative_Smooth#模型适配)
| Flex Smooth Quant| [Flex Smooth Quant：灵活平滑量化算法说明](../算法说明/Flex_Smooth_Quant#flex-smooth-quant灵活平滑量化算法说明)| [Flex Smooth Quant 适配](../算法说明/Flex_Smooth_Quant#模型适配)
