...
class Qwen3ModelAdapter(TransformersModel,
    ...
    def generate_model_visit(self, model: nn.Module, transformer_blocks: Optional[List[Tuple[str, nn.Module]]] = None,
                             ) -> Generator[ProcessRequest, Any, None]:  # 描述如何将模型分段，必须与模型结构匹配
...
4. **注册模型名**：在模型适配器上注册模型名称，便于同一系列的模型复用一个模型适配器。
...
@ModelFactory.register("Qwen3-32B")  # 命令行上可使用Qwen3-32B作为model_type
@logger_setter()
class Qwen3ModelAdapter(TransformersModel,  # 非必要，用于简化实现
                        ModelSlimPipelineInterfaceV1,  # 必要，服务于量化调度
                        ):
    ...
```

5. **注册模型适配器**：在 [`msmodelslim/model/__init__.py`](../../msmodelslim/model/__init__.py) 注册模型适配器，以便msModelSlim感知和使用新的模型适配器。

```python
from .default import DefaultModelAdapter
from .factory import ModelFactory

from .qwen3 import Qwen3ModelAdapter  # 注册模型适配器
...
| 算法               | 算法介绍       | 适配指导       |
| ------------------ | ------------- | ------------- |
| Iterative Smooth | [Iterative Smooth：离群值抑制算法说明](../功能指南/一键量化/v1架构/算法/Iterative_Smooth算法说明.md#iterative-smooth离群值抑制算法说明) | [Iterative Smooth 适配](../功能指南/一键量化/v1架构/算法/Iterative_Smooth算法说明.md#模型适配)
| Flex Smooth Quant| [Flex Smooth Quant：灵活平滑量化算法说明](../功能指南/一键量化/v1架构/算法/Flex_Smooth_Quant算法说明.md#flex-smooth-quant灵活平滑量化算法说明)| [Flex Smooth Quant 适配](../功能指南/一键量化/v1架构/算法/Flex_Smooth_Quant算法说明.md#模型适配)
| KV Smooth | [KVSmooth：KVCache量化离群值抑制算法说明](../功能指南/一键量化/v1架构/算法/kv_smooth.md#kvsmoothkvcache量化离群值抑制算法说明) | [KV Smooth 适配](../功能指南/一键量化/v1架构/算法/kv_smooth.md#模型适配)
| KVCache Quant | [KVCache量化：缓存量化算法说明](../功能指南/一键量化/v1架构/算法/KVCache_quant.md#kvcache量化缓存量化算法说明) | [KVCache Quant 适配](../功能指南/一键量化/v1架构/算法/KVCache_quant.md#新缓存类接入步骤)
| Histogram | [Histogram：直方图激活值量化算法说明](../功能指南/一键量化/v1架构/算法/histogram_activation_quantization.md#histogram直方图激活值量化算法说明) | [Histogram 适配](../功能指南/一键量化/v1架构/算法/histogram_activation_quantization.md#核心方法实现)
| SSZ | [SSZ：权重量化算法说明](../功能指南/一键量化/v1架构/算法/ssz.md#ssz权重量化算法说明) | [SSZ 适配](../功能指南/一键量化/v1架构/算法/ssz.md#模型适配)
| Float Sparse | [浮点稀疏：基于 ADMM （Alternating Direction Method of Multipliers，交替方向乘子法）的模型稀疏化算法说明](../功能指南/一键量化/v1架构/算法/float_sparse.md#浮点稀疏基于-admm-alternating-direction-method-of-multipliers交替方向乘子法的模型稀疏化算法说明) | [Float Sparse 适配](../功能指南/一键量化/v1架构/算法/float_sparse.md#模型适配)
| QuaRot | [QuaRot：基于旋转的离群值抑制算法说明](../功能指南/一键量化/v1架构/算法/QuaRot.md#quarot基于旋转的离群值抑制算法说明) | [QuaRot 适配](../功能指南/一键量化/v1架构/算法/QuaRot.md#模型适配)
| AutoRound | [AutoRound：低比特量化算法说明](../功能指南/一键量化/v1架构/算法/AutoRound.md#autoround低比特量化算法说明) | [AutoRound 适配](../功能指南/一键量化/v1架构/算法/AutoRound.md#模型适配)
| LAOS | [LAOS：w4a4量化方案说明](../功能指南/一键量化/v1架构/算法/LAOS.md#laosw4a4量化方案说明) | [LAOS 适配](../功能指南/一键量化/v1架构/算法/LAOS.md#模型适配)
## 量化自有模型
