...
if __name__ == "__main__":
    ...
    with open("anti_prompt_llama8b.json", "r") as file:
    ...
    disable_names = ['model.layers.31.mlp.down_proj', 'model.layers.0.self_attn.v_proj',
                     'model.layers.0.self_attn.q_proj', 'model.layers.0.self_attn.k_proj',
                     'model.layers.0.mlp.down_proj', 'model.layers.1.mlp.down_proj',
                     'model.layers.27.mlp.down_proj', 'model.layers.30.mlp.down_proj',
                     'model.layers.24.mlp.down_proj', 'model.layers.23.mlp.down_proj',
                     'model.layers.22.mlp.down_proj', 'model.layers.25.mlp.down_proj',
                     'model.layers.2.mlp.down_proj', 'model.layers.18.mlp.down_proj',
                     'model.layers.19.mlp.down_proj', 'model.layers.21.mlp.down_proj',
                     'model.layers.29.mlp.down_proj', 'model.layers.26.mlp.down_proj',
                     'model.layers.20.mlp.down_proj', 'model.layers.28.mlp.down_proj',
                     ]

    with open("calib_prompt_llama8b.json", "r") as file:
