...
disable_names = [f"model.layers.{i}.mlp.down_proj" for i in range(0,25)]
disable_names += [f"model.layers.{i}.mlp.down_proj" for i in range(40,50)]
disable_names += [f"model.layers.{i}.mlp.down_proj" for i in range(60,80)]
