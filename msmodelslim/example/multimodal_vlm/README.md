...
| Qwen2.5-VL | W8A8静态量化，W4A8动态量化【部署暂不支持】 | [Qwen2.5-VL-7B-Instruct](https://huggingface.co/Qwen/Qwen2.5-VL-7B-Instruct/tree/main)<br>[Qwen2.5-VL-72B-Instruct](https://huggingface.co/Qwen/Qwen2.5-VL-72B-Instruct/tree/main) | MindIE 预计2.2.RC1版本支持<br>vLLM Ascend v0.10.2rc2及之后版本支持 | [Qwen2.5-VL 量化使用说明](./Qwen2.5-VL/README.md) |
