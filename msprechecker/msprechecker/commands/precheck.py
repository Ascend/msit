...
def _add_model_args(parser):
    ...
    group.add_argument("--weight-dir", metavar="", type=existing_dir, help="Directory path containing model weights.")


def _add_stress_test_args(parser):
    group = parser.add_argument_group("Stress Test Options")
    group.add_argument(
        "--hardware", action="store_true", default=False, help="Enable hardware stress testing. Default: False."
    )
    group.add_argument(
        "--threshold",
        type=int,
